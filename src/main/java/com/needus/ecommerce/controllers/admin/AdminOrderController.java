...
public class AdminOrderController {
    ...
    public String orderDetails(@PathVariable(name="orderId") long orderId,
        ...
        try {
            ...
            log.error("Something went wrong while fetching order details");
            throw new TechnicalIssueException("Something went wrong while fetching order details");
        }
    }
    ...
    public String changeOrderStatus(@RequestParam(name="status",required = false) String value,
        ...
        try {
            ...
            log.error("Something went wrong while changing order status");
            throw new TechnicalIssueException("Something went wrong while changing order status");
        }
    }
    ...
    public String returnOrder(@PathVariable(name = "orderId") Long orderId,
        ...
        try {
            ...
            log.error("Something went wrong while accepting return request");
            throw new TechnicalIssueException("Something went wrong while accepting return request");
        }
    }
    ...
    public String cancelReturnRequest(@PathVariable(name = "orderId") Long orderId,
        ...
        try {
            ...
            log.error("Something went wrong while cancelling return request");
            throw new TechnicalIssueException("Something went wrong while cancelling return request");
        }
    }
}
